...
<div class="page-heading">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-10 "><h3>Selamat datang, Calon Penghuni</h3>
            </div>
            <div class="col-sm-2 ">
                ...
                <div class="dropdown">
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false" class="">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                ...
                                <p class="mb-0 text-sm text-gray-600">Applicant</p>
                            </div>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="min-width: 1rem;">
                        ...
                        <li><a class="dropdown-item" href="<?= route_to('applicant.accounts.index'); ?>">Akun</a></li>

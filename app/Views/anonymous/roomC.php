            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <h2 class="mb-4">Tipe C</h2>
                        <div class="single-slider owl-carousel">
                            <div class="item">
                                <div class="room-img" style="background-image: url(<?= base_url('anonymous/images/c-1.jpg') ?>);"></div>
                            </div>
                            <div class="item">
                                <div class="room-img" style="background-image: url(<?= base_url('anonymous/images/c-2.jpg') ?>);"></div>
                            </div>
                            <div class="item">
                                <div class="room-img" style="background-image: url(<?= base_url('anonymous/images/c-3.jpg') ?>);"></div>
                            </div>
                            <div class="item">
                                <div class="room-img" style="background-image: url(<?= base_url('anonymous/images/c-4.jpg') ?>); background-size: auto 100%;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 room-single ftco-animate mb-5 mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    <a href="<?= route_to('anonymous.rooms-b.index'); ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?= base_url('anonymous/images/room-2.jpg') ?>);">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                                    <div class="text p-3 text-center">
                                        ...
                                        <p><span class="price mr-2">Rp. 1.200K</span>&nbsp;/ Bulan <span class="per">&nbsp;</span></p>
                                        <hr>

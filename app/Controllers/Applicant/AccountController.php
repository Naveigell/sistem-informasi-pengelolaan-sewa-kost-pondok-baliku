...
class AccountController extends BaseController
{
    public function index()
    {
        ...
        return view('applicant/pages/account/index', compact('biodata', 'user'));
    }
    ...
    public function update()
    {
        ...
        return redirect('applicant.accounts.index')->withInput()->with('biodata-success', 'Berhasil mengubah biodata');
    }
    ...
    public function password()
    {
        ...
        return redirect()->route('applicant.accounts.index')->with('success', 'Berhasil mengubah password');
    }
}
